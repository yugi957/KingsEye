...
export const PIECES: Pieces = {
  br: require("../chess-assets/br.png"),
  bp: require("../chess-assets/bp.png"),
  bn: require("../chess-assets/bn.png"),
  bb: require("../chess-assets/bb.png"),
  bq: require("../chess-assets/bq.png"),
  bk: require("../chess-assets/bk.png"),
  wr: require("../chess-assets/wr.png"),
  wn: require("../chess-assets/wn.png"),
  wb: require("../chess-assets/wb.png"),
  wq: require("../chess-assets/wq.png"),
  wk: require("../chess-assets/wk.png"),
  wp: require("../chess-assets/wp.png"),
};
